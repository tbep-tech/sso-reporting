...
The following is an evaluation of FDEP spill incident reports for Tampa Bay, available at <https://prodenv.dep.state.fl.us/DepPNP/reports/viewIncidentDetails>, downloaded on *2024-12-04*. The workflow borrows from a previous analysis [here](https://tbep-tech.github.io/piney-point-analysis/spills).
